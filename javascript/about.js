...
// Mobile menu toggle - Fixed class names
    ...
    const animateOnScroll = function() {
        const elements = document.querySelectorAll('.milestone, .value-card, .team-member, .material-card, .cta-content');
    ...
    const animatedElements = document.querySelectorAll('.milestone, .value-card, .team-member, .material-card, .cta-content');
    ...
    // Add hover effect to team member contact icons
    ...
    const storyVideo = document.querySelector('.story-image video');
    if (storyVideo) {
